...
DEFAULTS = {
    ...
    "manques": [],
    "sub_problems": [],
    "selected_sub_problems_list": [],   # liste des 1 ou 2 sp sélectionnés (dicts)
    "selected_sub_problem": "",          # formulation finale (texte) transmise aux phases suivantes
    "resources": {},
    "constraints": {},
    ...
    if nb_sel == 2:
        ...
        with col_synth:
            if st.button("🤖 Synthétiser les 2 en un sous-problème affiné", type="primary",
                         use_container_width=True, disabled=not st.session_state.api_key):
